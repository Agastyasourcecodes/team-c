                  ...
                  <>
                    <div className="role-cards-row">
                      <div className="role-card-content">
                        ...
                        <h3>Citizen</h3>
                        <p>Create and sign petitions, voice your concerns</p>
                        <button className="select-role-btn" onClick={() => setSelectedRole('citizen')}>
                          Select
                        </button>
                      </div>
                      ...
                      <div className="role-card-content">
                        ...
                        <p>Review and respond to citizen petitions</p>
                        <button className="select-role-btn" onClick={() => setSelectedRole('official')}>
                          Select
                        </button>
                      </div>
                    </div>
