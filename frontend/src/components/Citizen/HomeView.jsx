        ...
        <section className="bg-slate-900 p-10 rounded-[3rem] text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
             {polls?.slice(0, 2).map(p => (
               <div key={p.id} className="p-6 bg-white/5 rounded-[2rem] border border-white/10 hover:border-indigo-500/50 hover:bg-white/10 transition-all group">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span 
                      onClick={() => onToast?.("🗳️ Opening Poll...")} 
