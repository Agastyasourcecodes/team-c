...
import { 
  ...
  Inbox, Vote, CheckCircle2, ShieldCheck 
} from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-900/5 p-10 rounded-[40px] border border-white backdrop-blur-md">
        <div className="space-y-2">
          <h1 className="text-5xl font-black text-slate-900 tracking-tight">
            Public Polls<span className="text-indigo-600">.</span>
          </h1>
          <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.4em]">
            Official Collective Intelligence System
          </p>
        </div>

        <div className="flex items-center gap-4 bg-white/60 px-8 py-5 rounded-[24px] border border-white shadow-sm">
          <div className="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-200">
            <ShieldCheck size={24} />
          </div>
          <div>
            <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest leading-none mb-1">Verified</p>
            <p className="text-[9px] font-bold text-slate-400 uppercase italic">Authorized by Governance</p>
          </div>
        </div>
      </div>
